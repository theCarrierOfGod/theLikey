...
<body>
                ...
                <div class="col-12">
                    ...
                    <div class="Offcanvas_menu_wrapper">
                        ...
                        <div class="Offcanvas_footer">
                            <span>
                                <a href="mailto:support@thelikey.com">
                                    <i class="fa fa-envelope-o"></i>
                                    support@thelikey.com
                                </a>
                            </span>
                            <ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="support_info">
                                <p>Email: <a href="mailto:support@thelikey.com">support@thelikey.com</a></p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-6">
                            <div class="logo">
                                <a href="/">
                                    <img src='/logo.png' alt="" width="40" class='rounded-circle' />
                                    <span
                                        style='font-family: monospace; font-weight: bold; font-size: 22px; color: white; margin-left: 10px; text-transform: uppercase;'>Likey</span>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
                    <h1>Get Likes and Followers from real users NOW!</h1>
                    <h2>We support all major Social Media Networks.</h2>
                    <a href="/about-us" class="btn-get-started scrollto mr-10">Get likes & followers</a>
                    <a href="/about-us" class="btn-get-started scrollto">Networks we support</a>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left">
                    <img src='/guest/assets/SocialBlog.png' class="img-fluid" alt="Hero" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="section" class='bg-light'>
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 hero-img" data-aos="fade-left">
                    <img src='/guest/assets/growth.webp' class="img-fluid" alt="Growth" />
                </div>
                <div class=" col-lg-6 py-5 py-lg-0 container" data-aos="fade-right">
                    <h1 style=" color: #5e91ff">How Likey Works?</h1>
                    <p style="font-size: 19px">
                        Get free credits by liking, and they will like back!
                    </p>
                    <ol type='1' style='font-size: 18px; margin: 0; padding:0; list-style: none'>
                        <li>
                            <span class="material-symbols-outlined"
                                style='line-height: 0; font-size: 16px; color: orange; font-weight: bold;'>
                                done
                            </span> &nbsp;
                            Join our community - startup bonus of 5 credits
                        </li>
                        <li>
                            <span class="material-symbols-outlined"
                                style='line-height: 0; font-size: 16px; color: orange; font-weight: bold;'>
                            ...
                            Add the Social Network Page you want to promote
                        </li>
                        <li>
                            <span class="material-symbols-outlined"
                                style='line-height: 0; font-size: 16px; color: orange; font-weight: bold;'>
                            ...
                            Buy credits or get Free credits by liking and following others' content
                        </li>
                        <li>
                            <span class="material-symbols-outlined"
                                style='line-height: 0; font-size: 16px; color:orange; font-weight: bold;'>
            ...
            <div class="single_slider d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                                <img src="/guest/assets/img/product/1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single_slider d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                                <img src="/guest/assets/img/product/2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single_slider d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="slider_content">
                                <img src="/guest/assets/img/product/3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="single-tranding">
                        <a href="product-details.html">
                            <div class="tranding-pro-img">
                                <img src="/guest/assets/img/product/tranding-1.jpg" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="single-tranding">
                        <a href="product-details.html">
                            <div class="tranding-pro-img">
                                <img src="/guest/assets/img/product/tranding-2.jpg" alt="">
                            </div>
                            <div class="tranding-pro-title">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="single-tranding">
                        <a href="product-details.html">
                            <div class="tranding-pro-img">
                                <img src="/guest/assets/img/product/tranding-3.jpg" alt="">
                            </div>
                            <div class="tranding-pro-title">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="single-features">
                        <img src="/guest/assets/img/icon/1.png" alt="">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="single-features">
                        <img src="/guest/assets/img/icon/2.png" alt="">
                        <h3>100% self safe</h3>
                        <p>consectetur adipisicing elit. Ut praesentium earum, blanditiis, voluptatem repellendus rerum
                            voluptatibus dignissimos</p>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="single-features">
                        <img src="/guest/assets/img/icon/3.png" alt="">
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                    <a href="#"><img src="/guest/assets/img/product/2.png" alt=""></a>
                </div>
            </div>
        </div>
    </section> -->
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="/guest/assets/img/product/details-1.jpg" data-zoom-image="assets/img/product/details-1.jpg" alt="big-1">
                            </a>
                        </div>
                            ...
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/details-2.jpg" data-zoom-image="assets/img/product/details-2.jpg">
                                        <img src="/guest/assets/img/product/details-2.jpg" alt="zo-th-1" />
                                    </a>
                                ...
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/details-3.jpg" data-zoom-image="assets/img/product/details-3.jpg">
                                        <img src="/guest/assets/img/product/details-3.jpg" alt="zo-th-1" />
                                    </a>
                                ...
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/details-4.jpg" data-zoom-image="assets/img/product/details-4.jpg">
                                        <img src="/guest/assets/img/product/details-4.jpg" alt="zo-th-1" />
                                    </a>
                                ...
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/details-1.jpg" data-zoom-image="assets/img/product/details-1.jpg">
                                        <img src="/guest/assets/img/product/details-1.jpg" alt="zo-th-1" />
                                    </a>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/136938394?color=FA5252&amp;title=0&amp;byline=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" allow="autoplay; fullscreen" allowfullscreen></iframe></div>
                    ...
                    <div class="testimonial_are">
                        <div class="testimonial_active owl-carousel">
                            <article class="single_testimonial">
                                <figure>
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="/guest/assets/img/about/team-3.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="testimonial_content">
                                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                                            roots in a piece of classical Latin literature from 45</p>
                            ...
                            <article class="single_testimonial">
                                <figure>
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="/guest/assets/img/about/team-1.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="testimonial_content">
                            ...
                            <article class="single_testimonial">
                                <figure>
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="/guest/assets/img/about/team-2.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="testimonial_content">
                                        <p>College in Virginia, looked up one of the more obscure Latin words,
                                            consectetur, from a Lorem Ipsum passage, and going through the cites</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widgets_container contact_us">
                            ...
                            <div class="footer_contact">
                                <p>
                                    Boost Your Social Media Marketing From Unexpected Friendships to Lasting
                                    Relationships
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widgets_container newsletter">
                            ...
                            <div class="subscribe_form d-none">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright_area">
                            <p>
                                ...
                                <?php echo date('Y'); ?> | <a href="/">LIKEY</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <a href="#">
                                <img src="/guest/assets/img/icon/payment.png" alt="">
                            </a>
                        </div>
                    </div>
                </div>
