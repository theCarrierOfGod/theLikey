...
<div class="row justify-content-center">
    <div class="col-md-3 stretch-card grid-margin">
        <div class="card bg-gradient-primary card-img-holder text-white">
            <div class="card-body p-2">
                ...
                <h4 class="font-weight-normal mb-3">Earned credits <i class="mdi mdi-coin mdi-24px"></i>
                </h4>
                <h2 class="mb-2">
                    <?= $user['earned']; ?><i class="mdi mdi-coin mdi-24px"></i>
                </h2>
            </div>
        </div>
    </div>
    <div class="col-md-3 stretch-card grid-margin">
        <div class="card bg-gradient-danger card-img-holder text-white">
            <div class="card-body p-2">
                <img src="/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                <h4 class="font-weight-normal mb-3">Deposited credits <i class="mdi mdi-coin mdi-24px"></i>
                </h4>
                <h2 class="mb-2">
                    <?= $user['deposited']; ?><i class="mdi mdi-coin mdi-24px"></i>
                </h2>
            </div>
        </div>
    </div>
    <div class="col-md-3 stretch-card grid-margin">
        <div class="card bg-gradient-warning card-img-holder text-white">
            <div class="card-body p-2">
                <img src="/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                <h4 class="font-weight-normal mb-3">Processed Credits <i class="mdi mdi-coin mdi-24px"></i>
                </h4>
                <h2 class="mb-2">
                    <?= $user['processed']; ?><i class="mdi mdi-coin mdi-24px"></i>
                </h2>
            </div>
        </div>
    </div>
    <div class="col-md-3 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white">
            <div class="card-body p-2">
                <img src="/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                <h4 class="font-weight-normal mb-3">Active tasks <i class="mdi mdi-bookmark-outline mdi-24px"></i>
                </h4>
                <h2 class="mb-2">
                    <?php
                    echo count($tasks);
    ...
    <div class="col-md-3 stretch-card grid-margin">
        <div class="card bg-gradient-success card-img-holder text-white">
            <div class="card-body p-2">
                <img src="/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                <h4 class="font-weight-normal mb-3">Active promos <i class="mdi mdi-diamond mdi-24px"></i>
                </h4>
                <h2 class="mb-2">
                    <?php
                    echo count($promotions);
                    ?>
                </h2>
            </div>
        </div>
    ...
    <div class="col-md-7 grid-margin stretch-card">
        <div class="card" style="height: 100%; margin-bottom: 20px">
            <div class="card-body">
                ...
                <ol class="activity-feed mb-0 ps-2" data-simplebar style="max-height: 345px; overflow-y: auto">
                    <?php
                        if(!empty($activities)) {
